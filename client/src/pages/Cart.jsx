    ...
    const placeOrder = async () => {
        try {
            if (!selectedAddress) {
             ...
             // Add this check BEFORE calling Stripe API
            if (paymentOption === "Online" && getCartAmount() < 42) {
            return toast.error("Minimum amount for online payment is ₹42");
            }
                     ...
                     items-center text-sm md:text-base font-medium pt-3">
                        <div className="flex items-center md:gap-6 gap-3">
                            <div onClick={() => {
                                ...
                                className="cursor-pointer w-24 h-24 flex items-center justify-center border
