...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-28 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            {/* Mobile Menu */}
            {open && (
               <div className={`${open ? 'flex' : 'hidden'} fixed top-[60px] left-0 w-full z-50 bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
